...
function Footer() {
  return (
    <footer className="w-screen h-64 bg-gradient-to-t from-black to-[#131313] flex flex-col justify-center items-center p-10 ">
      <h2 className="text-tigetgold italic font-semibold font-[30px]">PASSION FRUIT</h2>
